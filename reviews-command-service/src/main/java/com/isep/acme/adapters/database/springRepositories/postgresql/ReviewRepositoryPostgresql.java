...
public interface ReviewRepositoryPostgresql extends CrudRepository<ReviewPg, String> {
    ...
    @Query("SELECT r FROM review_postgresql r WHERE r.user.email=:userEmail")
    List<ReviewPg> findByUser(String userEmail);
    ...
    List<ReviewPg> deleteAllByProductSku(String sku);
