...
public class RabbitMqConfig {
    ...
    @Value("${rabbitmq.votes.fanout-exchange}")
    private String votesFanoutName;
    ...
    @Bean
    public FanoutExchange voteFanoutExchange() {
        return new FanoutExchange(votesFanoutName);
    }
    ...
    @Bean
    public Binding bindingReviews(Queue queueReview, FanoutExchange reviewFanoutExchange) {
        return BindingBuilder
                .bind(queueReview)
    ...
    @Bean
    public Binding bindingVotes(Queue queueVote, FanoutExchange voteFanoutExchange) {
        return BindingBuilder
                .bind(queueVote)
                .to(voteFanoutExchange);
    }
